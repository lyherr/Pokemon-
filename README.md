# In this project, we are trying to use different models to identify which variables can define the type of a Pokemon and predict whether a Pokemon is legendary or not
